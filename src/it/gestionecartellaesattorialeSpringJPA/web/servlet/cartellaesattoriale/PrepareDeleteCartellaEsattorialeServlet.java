...
/**
 * Servlet implementation class PrepareDeleteCartellaEsattorialeServlet
 */
...
public class PrepareDeleteCartellaEsattorialeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		CartellaEsattoriale cartellaEsattoriale = cartellaEsattorialeService
				.caricaSingolaCartellaEsattorialeEager(idCartellaEsattoriale);

		request.setAttribute("cartellaEsattorialeAttr", cartellaEsattoriale);
		request.getRequestDispatcher("/cartellaesattoriale/delete.jsp").forward(request, response);
	}
