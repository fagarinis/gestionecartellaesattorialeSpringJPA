...
import it.gestionecartellaesattorialeSpringJPA.model.StatoUtente;
...
public class UtenteDAOImpl implements UtenteDAO {
	...
	public Utente executeLogin(String username, String password) {
		Query query = entityManager.createQuery(
				"select u FROM Utente u where u.username = :usernameParam and u.password= :passwordParam and u.stato=:statoUtenteParam");
